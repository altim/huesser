...
<body>
	<div class="m-pikabu-viewport">
		<div class="m-pikabu-container">
            ...
            <div class="container-fluid background-light-gray wood-pattern-top">
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
			...
			<div class="container-fluid background-dark-gray wood-patern-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-4">
