...
//		// 	if($(window).width()>768){
//		// 		_self.closeSidebars();
//		// 		$(".m-pikabu-overlay").height("auto");
//		// 	}
//		// 	else {
//		// 		$(".m-pikabu-overlay").height($("html").height());
//		// 	}
//		// });
//
//
...
//            //Alex fix
//            if($(window).width()>992){
//            	$(".m-pikabu-viewport").css("height","auto");
//            	$(".m-pikabu-container").css("height","auto");
//                $(".m-pikabu-overlay").css("height","auto");
//                $(".m-pikabu-sidebar").css("height","auto");
//            }
//        });
//    }
//
...
(function($) {
	 ...
	 *
	 * @author Florian GÃ¤chter <florian.gaechter@gmail.com>
	 * @namespace Tc.Module
	 * @class Accordion
	 * @extends Tc.Module
	 */
	Tc.Module.Accordion = Tc.Module.extend({
		...
		on: function(callback) {
			...
			$ctx.find('.js-trigger').on('click', function() {
...
(function($) {
	 ...
	 *
	 * @author Florian GÃ¤chter <f>
	 * @namespace Tc.Module
	 * @class Contact
	 * @extends Tc.Module
	 */
	Tc.Module.Contact = Tc.Module.extend({
...
(function($) {
	"use strict";
	/**
	 * ContactBubble module implementation.
	 *
	 * @author Florian GÃ¤chter <florian.gaechter@gmail.com>
	 * @namespace Tc.Module
	 * @class ContactBubble
	 * @extends Tc.Module
	 */
	Tc.Module.ContactBubble = Tc.Module.extend({
...
(function($) {
	"use strict";
	/**
	 * DividerImage module implementation.
	 *
	 * @author Florian GÃ¤chter <florian.gaechter@gmail.com>
	 * @namespace Tc.Module
	 * @class DividerImage
	 * @extends Tc.Module
	 */
	Tc.Module.DividerImage = Tc.Module.extend({
...
(function($) {
	"use strict";
	/**
	 * DividerSlider module implementation.
	 *
	 * @author Florian GÃ¤chter <florian.gaechter@gmail.com>
	 * @namespace Tc.Module
	 * @class DividerSlider
	 * @extends Tc.Module
	 */
	Tc.Module.DividerSlider = Tc.Module.extend({
...
(function($) {
	...
	Tc.Module.Header = Tc.Module.extend({
		...
		on: function(callback) {
			...
			$ctx.find('.header-wrapper').headroom({
				offset : 105
			});
...
(function($) {
	...
	Tc.Module.Map = Tc.Module.extend({
		...
		on: function(callback) {
			...
			this._codeAddress($ctx.data('address'));

			callback();
		},

		_codeAddress: function(address) {
			var mod = this,
				$ctx = mod.$ctx;

			mod.geocoder = new google.maps.Geocoder();
			mod.geocoder.geocode({
				'address': address
			}, function(results, status) {
				if (status == google.maps.GeocoderStatus.OK) {
					mod.map = new google.maps.Map($ctx.get(0), {
						zoom: $ctx.data('zoom'),
						center: results[0].geometry.location,
						mapTypeId: google.maps.MapTypeId.ROADMAP
					});

					mod.marker = new google.maps.Marker({
						map: mod.map,
...
(function($) {
	...
	Tc.Module.NavMain = Tc.Module.extend({
		...
		on: function(callback) {
            ...
            //    viewportSelector: '.m-pikabu-viewport',
            //    selectors: {
            //        navToggles: '.js-mobile-menu-trigger'
            //    },
            //    widths: {
            //        right: '300px'
            //    }
...
(function($) {
	 ...
	 * @extends Tc.Module
	 */
	Tc.Module.Newsletter = Tc.Module.extend({
...
(function($) {
	 ...
	 * @extends Tc.Module
	 */
	Tc.Module.Tile = Tc.Module.extend({
